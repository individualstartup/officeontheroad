...
export class PublicApiApi extends runtime.BaseAPI {
  /**
   */
  async checkReservationRaw(
    requestParameters: CheckReservationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<CheckReservationOutDTO>>> {
    if (requestParameters.checkReservationInDTO === null || requestParameters.checkReservationInDTO === undefined) {
      throw new runtime.RequiredError(
        'checkReservationInDTO',
        'Required parameter requestParameters.checkReservationInDTO was null or undefined when calling checkReservation.',
      );
    }
  ...
  async checkReservation(
    requestParameters: CheckReservationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<CheckReservationOutDTO>> {
  ...
  /**
   */
  async computePriceRaw(
    requestParameters: ComputePriceRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<ComputePriceOutDTO>> {
    if (requestParameters.resourceId === null || requestParameters.resourceId === undefined) {
      throw new runtime.RequiredError(
        'resourceId',
        'Required parameter requestParameters.resourceId was null or undefined when calling computePrice.',
      );
    }
    ...
    if (requestParameters.since === null || requestParameters.since === undefined) {
      throw new runtime.RequiredError(
        'since',
        'Required parameter requestParameters.since was null or undefined when calling computePrice.',
      );
    }
    ...
    if (requestParameters.till === null || requestParameters.till === undefined) {
      throw new runtime.RequiredError(
        'till',
        'Required parameter requestParameters.till was null or undefined when calling computePrice.',
      );
    }
    ...
    if (requestParameters.since !== undefined) {
      queryParameters['since'] = (requestParameters.since as any).toISOString().substr(0, 10);
    }

    if (requestParameters.till !== undefined) {
      queryParameters['till'] = (requestParameters.till as any).toISOString().substr(0, 10);
    }
    ...
    const response = await this.request(
      {
        path: `/public-api/{resourceId}/compute-price`.replace(
          `{${'resourceId'}}`,
  ...
  /**
   */
  async createResourceReservationRaw(
    requestParameters: CreateResourceReservationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
    ...
    if (requestParameters.reservationInDTO === null || requestParameters.reservationInDTO === undefined) {
      throw new runtime.RequiredError(
        'reservationInDTO',
        'Required parameter requestParameters.reservationInDTO was null or undefined when calling createResourceReservation.',
      );
    }
  ...
  /**
   */
  async createResourceReservation(
    requestParameters: CreateResourceReservationRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<number> {
  ...
  /**
   */
  async getDisabledDaysForResourceGroupRaw(
    requestParameters: GetDisabledDaysForResourceGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<DisabledDayDTO>>> {
    if (requestParameters.resourceGroup === null || requestParameters.resourceGroup === undefined) {
      throw new runtime.RequiredError(
        'resourceGroup',
        'Required parameter requestParameters.resourceGroup was null or undefined when calling getDisabledDaysForResourceGroup.',
      );
    }
    ...
    if (requestParameters.since === null || requestParameters.since === undefined) {
      throw new runtime.RequiredError(
        'since',
        'Required parameter requestParameters.since was null or undefined when calling getDisabledDaysForResourceGroup.',
      );
    }
    ...
    if (requestParameters.till === null || requestParameters.till === undefined) {
      throw new runtime.RequiredError(
        'till',
        'Required parameter requestParameters.till was null or undefined when calling getDisabledDaysForResourceGroup.',
      );
    }
    ...
    const response = await this.request(
      {
        path: `/public-api/get-blocked-days/{resourceGroup}/{since}/{till}`
          .replace(`{${'resourceGroup'}}`, encodeURIComponent(String(requestParameters.resourceGroup)))
          .replace(`{${'since'}}`, encodeURIComponent(String(requestParameters.since)))
          .replace(`{${'till'}}`, encodeURIComponent(String(requestParameters.till))),
        method: 'GET',
        headers: headerParameters,
        query: queryParameters,
      },
  ...
  /**
   */
  async getDisabledDaysForResourceGroup(
    requestParameters: GetDisabledDaysForResourceGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<DisabledDayDTO>> {
  ...
  /**
   */
  async getGuestInfoRaw(
    requestParameters: GetGuestInfoRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<GuestInfoOutDTO>> {
    if (requestParameters.guestResourceKey === null || requestParameters.guestResourceKey === undefined) {
      throw new runtime.RequiredError(
        'guestResourceKey',
        'Required parameter requestParameters.guestResourceKey was null or undefined when calling getGuestInfo.',
      );
    }
    ...
    const response = await this.request(
      {
        path: `/public-api/{guestResourceKey}/guest-info`.replace(
          `{${'guestResourceKey'}}`,
          encodeURIComponent(String(requestParameters.guestResourceKey)),
        ),
        method: 'GET',
        headers: headerParameters,
        query: queryParameters,
  ...
  /**
   */
  async getResourceCalendarInfoRaw(
    requestParameters: GetResourceCalendarInfoRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<DayInfo>>> {
    if (requestParameters.resourceUUID === null || requestParameters.resourceUUID === undefined) {
      throw new runtime.RequiredError(
        'resourceUUID',
        'Required parameter requestParameters.resourceUUID was null or undefined when calling getResourceCalendarInfo.',
      );
    }
    ...
    if (requestParameters.since === null || requestParameters.since === undefined) {
      throw new runtime.RequiredError(
        'since',
        'Required parameter requestParameters.since was null or undefined when calling getResourceCalendarInfo.',
      );
    }
    ...
    if (requestParameters.till === null || requestParameters.till === undefined) {
      throw new runtime.RequiredError(
        'till',
        'Required parameter requestParameters.till was null or undefined when calling getResourceCalendarInfo.',
      );
    }
    ...
    const response = await this.request(
      {
        path: `/public-api/get-calendar-info/{resourceUUID}/{since}/{till}`
          .replace(`{${'resourceUUID'}}`, encodeURIComponent(String(requestParameters.resourceUUID)))
          .replace(`{${'since'}}`, encodeURIComponent(String(requestParameters.since)))
          .replace(`{${'till'}}`, encodeURIComponent(String(requestParameters.till))),
        method: 'GET',
        headers: headerParameters,
  ...
  /**
   */
  async getResourceCalendarInfo(
    requestParameters: GetResourceCalendarInfoRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<DayInfo>> {
  ...
  /**
   */
  async listResourceGroupRaw(
    requestParameters: ListResourceGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<PensionRoomListOutDTO>>> {
    if (requestParameters.resourceGroupId === null || requestParameters.resourceGroupId === undefined) {
      throw new runtime.RequiredError(
        'resourceGroupId',
        'Required parameter requestParameters.resourceGroupId was null or undefined when calling listResourceGroup.',
      );
    }
    ...
    if (requestParameters.resourceGroupType === null || requestParameters.resourceGroupType === undefined) {
      throw new runtime.RequiredError(
        'resourceGroupType',
        'Required parameter requestParameters.resourceGroupType was null or undefined when calling listResourceGroup.',
      );
    }
    ...
    const response = await this.request(
      {
        path: `/public-api/resource-group/{resourceGroupType}/{resourceGroupId}/list-resources`
          .replace(`{${'resourceGroupId'}}`, encodeURIComponent(String(requestParameters.resourceGroupId)))
          .replace(`{${'resourceGroupType'}}`, encodeURIComponent(String(requestParameters.resourceGroupType))),
        method: 'GET',
        headers: headerParameters,
        query: queryParameters,
      },
  ...
  async listResourceGroup(
    requestParameters: ListResourceGroupRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<PensionRoomListOutDTO>> {
  ...
  /**
   */
  async loadResourceDetailsRaw(
    requestParameters: LoadResourceDetailsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<Array<RoomDetailOutDTO>>> {
    const queryParameters: any = {};
  ...
  async loadResourceDetails(
    requestParameters: LoadResourceDetailsRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<Array<RoomDetailOutDTO>> {
  ...
  /**
   */
  async updateGuestInfoRaw(
    requestParameters: UpdateGuestInfoRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.guestResourceKey === null || requestParameters.guestResourceKey === undefined) {
      throw new runtime.RequiredError(
        'guestResourceKey',
        'Required parameter requestParameters.guestResourceKey was null or undefined when calling updateGuestInfo.',
      );
    }
    ...
    if (requestParameters.guestInfoInDTO === null || requestParameters.guestInfoInDTO === undefined) {
      throw new runtime.RequiredError(
        'guestInfoInDTO',
        'Required parameter requestParameters.guestInfoInDTO was null or undefined when calling updateGuestInfo.',
      );
    }
...
export type ListResourceGroupResourceGroupTypeEnum =
  typeof ListResourceGroupResourceGroupTypeEnum[keyof typeof ListResourceGroupResourceGroupTypeEnum];
