...
const nextConfig = {
  publicRuntimeConfig: {
    ...
    AUTH0_REDIRECT_URI: process.env.AUTH0_REDIRECT_URI || 'https://www.officeontheroad.cz/auth/callback',
    FRONTEND_BE_HOST: process.env.FRONTEND_BE_HOST || 'https://www.officeontheroad.cz',
    FRONT_URL: process.env.FRONT_URL || 'https://www.officeontheroad.cz',
